...
export const FIGURES: Figure[] = [
  ...
  { name: "Ilya Sutskever", xHandle: "ilyasut", org: "SSI", role: "researcher", priority: 1 },
  ...
  { name: "Greg Brockman", xHandle: "gdb", org: "OpenAI", role: "president", priority: 2 },
  { name: "Aravind Srinivas", xHandle: "AravSrinivas", org: "Perplexity", role: "CEO", priority: 2 },
  { name: "Clement Delangue", xHandle: "ClementDelangue", org: "Hugging Face", role: "CEO", priority: 2 },
  { name: "Jim Fan", xHandle: "DrJimFan", org: "NVIDIA", role: "researcher", priority: 2 },
  { name: "Fei-Fei Li", xHandle: "drfeifei", org: "Stanford", role: "researcher", priority: 2 },
  { name: "François Chollet", xHandle: "fchollet", org: "Keras/Ndea", role: "researcher", priority: 2 },
  { name: "Mustafa Suleyman", xHandle: "mustafasuleyman", org: "Microsoft AI", role: "CEO", priority: 2 },
  { name: "Noam Brown", xHandle: "polynoamial", org: "OpenAI", role: "researcher", priority: 2 },
];
